...
FPS = 24
W, H = 1920, 1080
SAIDA = os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets", "hero")
...
for quadro, nome in ((1, "apagada"), (FRAMES, "acesa")):
    cena.frame_set(quadro)
    cena.render.filepath = os.path.join(SAIDA, nome)
    bpy.ops.render.render(write_still=True)
    print(f"[hero] {nome} ok", file=sys.stderr)
